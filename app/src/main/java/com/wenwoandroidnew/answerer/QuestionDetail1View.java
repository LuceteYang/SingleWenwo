 ...
 */
public class QuestionDetail1View extends FrameLayout {
    ...
    public QuestionDetail1View(Context context) {
        super(context);
        init();
    }

    public QuestionDetail1View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void init(){
        inflate( getContext(), R.layout.view_question_detail1, this);
        this.iconView = (ImageView) findViewById( R.id.icon_question_detail_w);
        this.questionCategory = (TextView) findViewById( R.id.text_category_detail_w);
        this.questionVoteNumber = (TextView) findViewById( R.id.text_vote_number_detail_w);
        this.questionTitle = (TextView) findViewById( R.id.text_question_title_detail1_w);
        this.questionPName = (TextView) findViewById( R.id.text_question_name_detail_w);
        this.questionTime = (TextView) findViewById( R.id.text_question_time_detail_w);
        this.questionLocation = (TextView) findViewById( R.id.text_question_location_detail_w);
        this.questionContext = (TextView) findViewById( R.id.text_question_context_detail1_w);
        this.questionAccept = (TextView) findViewById( R.id.text_question_accept_detail_w);
        this.questionImage1 = (ImageView) findViewById(R.id.iv_question_detail1_w);
        this.questionImage2 = (ImageView) findViewById(R.id.iv_question_detail2_w);
        this.modifyImage = (ImageView)findViewById(R.id.imageView4_w);
        this.statusview = (RelativeLayout)findViewById(R.id.relativeLayout_w);
        this.profileView = (ImageView)findViewById(R.id.imageView3_detail_w);
        this.imageviewLayout = (RelativeLayout)findViewById(R.id.imageviewLayout_w);
    }
