...
public final class Intents {
  ...
  public static final class Scan {
    ...
    /**
     * By default11PNG, sending Scan.ACTION will decode all barcodes that we understand. However it
  ...
  public static final class WifiConnect {
	    ...
	    /**
	     * The network to connectGoogleLocationService to, all the configuration provided here.
	     */
