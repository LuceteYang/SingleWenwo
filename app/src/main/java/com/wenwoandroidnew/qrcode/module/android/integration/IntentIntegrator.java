...
package com.wenwoandroidnew.qrcode.module.android.integration;
...
import com.wenwoandroidnew.qrcode.module.android.CaptureActivity;
...
public final class IntentIntegrator {
  ...
  public static final int REQUEST_CODE = 9999; // get it?
   ...
   * same, but uses default11PNG English labels.
   */
  ...
  public static AlertDialog initiateScan(Activity activity,
    ...
    Intent intentScan = new Intent( activity, CaptureActivity.class); // 수정
